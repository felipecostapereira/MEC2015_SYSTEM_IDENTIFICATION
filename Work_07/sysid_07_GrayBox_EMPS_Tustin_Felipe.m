...
Fs   = denorm(Fsn,  parammax(4),parammin(4));
vs   = denorm(vsn,  parammax(5),parammin(5));
...
paramhatIDIM = [95.681 203.36 17.023 17.0230 0.006464 -4.12]';
paramhatIDIM' 
...
yhatIDIM2 = XhatIDIM(1,:)';


% saving vars to plot
save('r_tustin.mat','t','y_data','yhat2','yhatIDIM2')

figure
hold on
plot(t,y_data,'k-','linewidth',1.5)
plot(t,yhat2,'r--','linewidth',1.5)
plot(t,yhatIDIM2,'g--','linewidth',1.5)
grid on
xlabel('time')
...
plot(t,y_data-yhatIDIM2,'g--','linewidth',1.5)
grid on
xlabel('time')
ylabel('error')
